...
class ModelArguments:
    ...
    model_type: str = field(default="bert", metadata={"help": "One of 't5', 'bert'"})


@dataclass
class InteractiveArguments:
    passage_reps: str = field(default=None, metadata={"help": "Path to the folder that stores passage "
                                                              "representations."})
...
class DataArguments:
    ...
    pre_tokenized: bool = field(default=False)

    typo_augmentation: bool = field(default=False)
    self_teaching: bool = field(default=False)
    contrastive_training: bool = field(default=False)
    rodr_training: bool = field(default=False)
...
class DenseTrainingArguments(TrainingArguments):
    ...
    # the weight of total loss for contrastive training
    w1: float =  field(default=1.0, metadata={"help": "The weight on the negative log likelihood loss between "
                                                      "query and passages."})
    w2: float = field(default=1.0, metadata={"help": "The weight on the contrastive loss between query and "
                                                     "typo_query."})
    w3: float = field(default=1.0, metadata={"help": "he weight on the negative log likelihood loss between "        
                                                     "typo_query and passages."})
